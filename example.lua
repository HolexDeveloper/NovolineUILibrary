...
-- Load from repo
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/HolexDeveloper/NovolineUILibrary/refs/heads/main/Library.lua"))() or
(function()
...
-- ============ VISUALS TAB ============
Tabs["Visuals"] = Window:AddTab({Title = "Visuals"})
...
-- ============ MISC TAB ============
Tabs["Misc"] = Window:AddTab({Title = "Misc"})
...
-- ============ KEYBINDS TAB ============
Tabs["Keybinds"] = Window:AddTab({Title = "Keybinds"})
...
-- ============ UI SETTINGS TAB ============
Tabs["UI Settings"] = Window:AddTab({Title = "UI Settings"})
...
local LicenseBox = Tabs["UI Settings"]:AddRightGroupbox({Title = "License"})

LicenseBox:AddLabel("License: Free")
LicenseBox:AddLabel("Expires: Never")
LicenseBox:AddDivider()
LicenseBox:AddLabel("Novoline UI v1.0.0")
LicenseBox:AddLabel("Made by @thedude_whotalks")
